...
function jsonToHtml(json) {
    ...
    <body>
       <div class="container mx-auto p-3">
          ...
          <div id="content" class="px-10 py-3 my-3 flex flex-col rounded-xl container mx-auto shadow-2xl"></div>
       ...
       <script>
          ...
          const dummy = generateEmptyComponent(360)
         ...
         function generate_header(headerData) {
            ...
            headerHtml += flattenedHeaderData.map((item) => {
               if (item.componentType === "header-image") {
                  headerHeight += (item.height * 345) / (11 * 100);
            ...
            headerHtml += '<div class="grid grid-cols-2">';
            ...
            headerHeight += calculateHeaderHeight(headerData) * 345 / (11 * 4) + 345 / 13
         ...
         function generate_report(headerData, reportData, header) {
            ...
            let footerData = flattenedHeaderData.map((item) => {
               if (item.componentType === "footer-image") {
                  footerHeight += (item.height * 345) / (11 * 100);
            ...
            flattenedReportData.forEach((item, idx) => {
               ...
               if (newHeight <= 0) {
                  ...
                  // currentPageHeight = currentPageHeight + footerHeight
                  // html += generateEmptyComponent(currentPageHeight * 345 / 20)
